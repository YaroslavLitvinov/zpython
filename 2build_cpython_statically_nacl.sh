...
PLAT=${HOME}/nacl_sdk/pepper_23/toolchain/linux_x86_glibc
ZRT_ROOT=${HOME}/git/zrt/lib
LINK="-T ${PLAT}/x86_64-nacl/lib64/ldscripts/elf64_nacl.x.static -melf64_nacl -m64 -L${ZRT_ROOT} -lzrt -lfs -lstdc++ -lzglibc"
