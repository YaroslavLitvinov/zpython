...
BASECFLAGS=	
CONFIGURE_CFLAGS=	-D__NACL__ -I/home/yaroslav/git/zrt/lib
CONFIGURE_CPPFLAGS=	
...
SGI_ABI=	
CCSHARED=	-fPIC
LINKFORSHARED=	-T /home/yaroslav/nacl_sdk/pepper_23/toolchain/linux_x86_glibc/x86_64-nacl/lib64/ldscripts/elf64_nacl.x.static -melf64_nacl -m64 -L/home/yaroslav/git/zrt/lib -lzrt -lfs -lstdc++ -lzglibc
ARFLAGS=	rc
...
CONFIG_ARGS=	 '--host=x86_64-nacl' '--build=x86_64-linux-gnu' '--prefix=/python' '--without-threads' '--enable-shared=no' 'build_alias=x86_64-linux-gnu' 'host_alias=x86_64-nacl' 'CC=x86_64-nacl-gcc' 'CFLAGS=-D__NACL__ -I/home/yaroslav/git/zrt/lib' 'LDFLAGS= -s -static -static-libgcc'
